...
#SBATCH --job-name=loebkens_np_1_1_0_400_iterations_part2

#SBATCH --account=gane

#SBATCH --output=logs/outputs_np_1_1_0_400_iterations_part2.out

#SBATCH --error=logs/errors_np_1_1_0_400_iterations_part2.err
