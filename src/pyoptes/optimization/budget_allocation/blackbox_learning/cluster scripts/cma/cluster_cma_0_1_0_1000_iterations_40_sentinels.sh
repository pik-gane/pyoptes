...
#SBATCH --job-name=loebkens_cma_0_1_0_1000_iterations_40_sentinels

#SBATCH --account=gane

#SBATCH --output=logs/outputs_cma_0_1_0_1000_iterations_40_sentinels.out

#SBATCH --error=logs/errors_cma_0_1_0_1000_iterations_40_sentinels.err
