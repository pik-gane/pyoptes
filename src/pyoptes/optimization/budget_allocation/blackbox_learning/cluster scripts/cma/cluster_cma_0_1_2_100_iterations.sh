...
#SBATCH --job-name=loebkens_cma_0_1_2_100_iterations

#SBATCH --account=gane

#SBATCH --output=logs/outputs_cma_0_1_2_100_iterations.out

#SBATCH --error=logs/errors_cma_0_1_2_100_iterations.err
