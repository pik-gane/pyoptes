...
#SBATCH --job-name=loebkens_cma_0_1_2_100_iterations_part2

#SBATCH --account=gane

#SBATCH --output=logs/outputs_cma_0_1_2_100_iterations_part2.out

#SBATCH --error=logs/errors_cma_0_1_2_100_iterations_part2.err
