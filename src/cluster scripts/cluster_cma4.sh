...
#SBATCH --output=outputs_cma4.out

#SBATCH --error=errors_cma4.err
...
source activate bbo
srun -n $SLURM_NTASKS python3 /home/loebkens/pyoptes/src/bb_optimization.py cma 20220513_cma_rms \
