...
#SBATCH --output=outputs_gpgo.out

#SBATCH --error=errors_gpgo.err
...
source activate bbo
srun -n $SLURM_NTASKS python3 /home/loebkens/pyoptes/src/bb_optimization.py gpgo 20220513_gpgo_95perc \
